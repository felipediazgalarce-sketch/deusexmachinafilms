...
META = {
 ...
 "collaborations/": ("Weitere Kooperationen — dEUSeXmACHINA films",
      "Kameraarbeit von Felipe Díaz Galarce für andere Künstler*innen: Tanz, Performance, Musik und Theater in Chile — TIBIA, PAISAJE LOA, MEMBRANA, Artidanza, Emmanuel Bermedo, Al Caer la Noche und F.A.S.E. 0.", None, None),
